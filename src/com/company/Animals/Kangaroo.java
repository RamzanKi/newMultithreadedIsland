...
public class Kangaroo extends Herbivore {
    ...
    private final double weight = 47.0;
    private final int maxAmountInCell = 149;
    private final int maxSpeed = 2 + 1;
    private final double foodForSatiety = 7.0;
    private final int numberOfMovesAfterHunger = 8;
